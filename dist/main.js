...
function highlightShipArea(startIndex, ship) {
    ...
    if (isValid && notTaken) {
        shipBlocks.forEach((block) => {
            ...
            setTimeout(() => block.classList.remove("hover"), 250);
        });
    }
}
